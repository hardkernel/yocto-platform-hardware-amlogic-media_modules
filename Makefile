...
#  decoder // format ko want to be compiled
TARGET_VENDOR_MEDIA_VVC_SUPPORT := true
TARGET_VENDOR_MEDIA_VC1_SUPPORT := true
TARGET_VENDOR_MEDIA_H264_SUPPORT := true
TARGET_VENDOR_MEDIA_H265_SUPPORT := true
TARGET_VENDOR_MEDIA_MPEG2_SUPPORT := true
TARGET_VENDOR_MEDIA_MPEG4_SUPPORT := true
TARGET_VENDOR_MEDIA_VP9_SUPPORT := true
TARGET_VENDOR_MEDIA_MJPEG_SUPPORT := true
TARGET_VENDOR_MEDIA_AVS_SUPPORT := true
TARGET_VENDOR_MEDIA_AVS2_SUPPORT := true
TARGET_VENDOR_MEDIA_AVS3_SUPPORT := true
TARGET_VENDOR_MEDIA_AV1_SUPPORT := true


CONFIGS ?= CONFIG_AMLOGIC_MEDIA_VENC_H264=m \
	...
	CONFIG_AMLOGIC_MEDIA_DHP=m \
	CONFIG_AMLOGIC_MEDIA_VDEC_AVBCD=m
...
ifeq ($(TARGET_VENDOR_MEDIA_VC1_SUPPORT), true)
CONFIGS += CONFIG_AMLOGIC_MEDIA_VDEC_VC1=m \
			CONFIG_AMLOGIC_MEDIA_VDEC_VC1_MULTI=m
endif

ifeq ($(TARGET_VENDOR_MEDIA_H264_SUPPORT), true)
CONFIGS +=	CONFIG_AMLOGIC_MEDIA_VDEC_H264_MULTI=m \
			CONFIG_AMLOGIC_MEDIA_VDEC_H264_MVC=m
endif

ifeq ($(TARGET_VENDOR_MEDIA_H265_SUPPORT), true)
CONFIGS +=	CONFIG_AMLOGIC_MEDIA_VDEC_H265=m \
			CONFIG_AMLOGIC_MEDIA_VDEC_H265_FB=m
endif

ifeq ($(TARGET_VENDOR_MEDIA_MPEG2_SUPPORT), true)
CONFIGS += CONFIG_AMLOGIC_MEDIA_VDEC_MPEG2_MULTI=m
endif

ifeq ($(TARGET_VENDOR_MEDIA_MPEG4_SUPPORT), true)
CONFIGS += CONFIG_AMLOGIC_MEDIA_VDEC_MPEG4_MULTI=m
endif

ifeq ($(TARGET_VENDOR_MEDIA_VP9_SUPPORT), true)
CONFIGS += 	CONFIG_AMLOGIC_MEDIA_VDEC_VP9_FB=m \
			CONFIG_AMLOGIC_MEDIA_VDEC_VP9=m
endif

ifeq ($(TARGET_VENDOR_MEDIA_MJPEG_SUPPORT), true)
CONFIGS += CONFIG_AMLOGIC_MEDIA_VDEC_MJPEG_MULTI=m
endif

ifeq ($(TARGET_VENDOR_MEDIA_AVS_SUPPORT), true)
CONFIGS +=	CONFIG_AMLOGIC_MEDIA_VDEC_AVS_MULTI=m
endif

ifeq ($(TARGET_VENDOR_MEDIA_AVS2_SUPPORT), true)
CONFIGS +=	CONFIG_AMLOGIC_MEDIA_VDEC_AVS2=m \
			CONFIG_AMLOGIC_MEDIA_VDEC_AVS2_FB=m
endif

ifeq ($(TARGET_VENDOR_MEDIA_AVS3_SUPPORT), true)
CONFIGS +=	CONFIG_AMLOGIC_MEDIA_VDEC_AVS3=m
endif

ifeq ($(TARGET_VENDOR_MEDIA_AV1_SUPPORT), true)
CONFIGS +=	CONFIG_AMLOGIC_MEDIA_VDEC_AV1=m \
