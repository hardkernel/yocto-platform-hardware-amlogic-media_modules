...
#define MEDIASYNC_IOC_SET_PCR_AND_DMX_ID _IOW(MEDIASYNC_IOC_MAGIC, 0x5E, int)
#define MEDIASYNC_IOC_SET_AUDIO_SWITCH _IOW(MEDIASYNC_IOC_MAGIC, 0x5F, int)
#define MEDIASYNC_IOC_GET_AUDIO_SWITCH _IOW(MEDIASYNC_IOC_MAGIC, 0x60, int)

#define MEDIASYNC_IOC_UPDATE_SPEED_MEDIATIME _IOW(MEDIASYNC_IOC_MAGIC, 0x61, int)

#define MEDIASYNC_IOC_ALLOC_VF_DEV_ID _IOW(MEDIASYNC_IOC_MAGIC, 0x62, int)
#define MEDIASYNC_IOC_FREE_VF_DEV_ID _IOW(MEDIASYNC_IOC_MAGIC, 0x63, int)
#define MEDIASYNC_IOC_SET_DEFAULT_THRESHOLD _IOW(MEDIASYNC_IOC_MAGIC, 0x64, int)
#define MEDIASYNC_IOC_GET_DEFAULT_THRESHOLD _IOW(MEDIASYNC_IOC_MAGIC, 0x65, int)
#define MEDIASYNC_IOC_SET_PREPLAY_SLOWSYNC _IOW(MEDIASYNC_IOC_MAGIC, 0x66, int)
#define MEDIASYNC_IOC_GET_PREPLAY_SLOWSYNC _IOW(MEDIASYNC_IOC_MAGIC, 0x67, int)

#define MEDIASYNC_IOC_SET_CUR_VFRAME_PACKET_INFO _IOW(MEDIASYNC_IOC_MAGIC, 0x68, int)
#define MEDIASYNC_IOC_GET_CUR_VFRAME_PACKET_INFO _IOW(MEDIASYNC_IOC_MAGIC, 0x69, int)

#define MEDIASYNC_IOC_SET_CUR_AFRAME_PACKET_INFO _IOW(MEDIASYNC_IOC_MAGIC, 0x6a, int)
#define MEDIASYNC_IOC_GET_CUR_AFRAME_PACKET_INFO _IOW(MEDIASYNC_IOC_MAGIC, 0x6b, int)
#endif
